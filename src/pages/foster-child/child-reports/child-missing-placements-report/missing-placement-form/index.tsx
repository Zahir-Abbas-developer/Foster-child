...
// import { useGetSingleMissingPlacementDataQuery } from "@root/services/foster-child/child-reports/missing-placement/MissingPlacement";
...
MissingPlacementReport.getLayout = function getLayout(
  page: any,
  { query }: NextRouter
) {
  return (
...
export default function MissingPlacementReport() {
  const { query } = useRouter();

//   const { data, isLoading } = useGetSingleMissingPlacementDataQuery(
//     {
//       id: query?.id,
//     },
//     {
