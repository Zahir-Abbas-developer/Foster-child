...
export const TAGS = [
  ...
  "PLACEMENT_MEETING_RECORDS",
  "REVIEW_OFFICER_REPORTS",
  "FOSTRING_SERVICE_MANAGER_REPORTS",
  "CHILD_ALLEGATION_REPORTS",
  "SUPERVISORY_HOME_VISIT",
  "MANAGE_FAQS",
  "CLA_DOCUMENTATION_REPORTS",
  "PLACEMENT_MEETING_RECORDS",
  ...
  "THIRD_PARTY_LICENSE",
  "CHILD_RESPITE_PLACEMENT",
  "REJECTIONS_PLACEMENT",
  "YOUNG_PERSON_REPORT",
  "DISCHARGE_PLACEMENT",
  "REJECTIONS_PLACEMENT",
  "BACKUP_ARCHIEVE",
  "MISSING_PLACEMENT_REPORT",
  "CHILD_PLACEMENTS_REPORT",
  "DISCHARGE_PLACEMENT",
  "REJECTIONS_PLACEMENT",
  "TRANSFER_PLACEMENT",
  "BACKUP_PLACEMENT",
  "CHILD_SOCIAL_WORKER_REPORT",
  "CHILD_LIVING_IN_THE_HOUSEHOLD_COMMENTS",
];
